...
### Purpose:
Represents the running cost of an EV per kilometer
Used to compare operating efficiency with petrol vehicles
Helps determine day-to-day affordability of EVs
Forms the base for cost comparison and savings calculation

## 2. Petrol Cost Per Km
Calculation: Petrol Cost per Km = Petrol Price per Liter / Mileage (Km per Liter)

### Purpose:
Calculates the fuel cost per kilometer for petrol vehicles
Enables direct comparison with EV running cost
Critical for evaluating cost efficiency gap

### 3. Cost Saving Per Km
Calculation: Cost Saving per Km = Petrol Cost per Km – EV Cost per Km

## Purpose:
Measures savings achieved by using EV instead of petrol vehicle
Core metric for financial comparison
Used to calculate long-term savings and break-even period

### 4. Annual Savings (USD)
Calculation: Annual Savings = Cost Saving per Km × Annual Distance Travelled

## Purpose:
Estimates total yearly savings from EV usage
Converts per km savings into real-world financial impact
Key input for break-even analysis

### 5. EV CO₂ Per Km (g)
Calculation: EV CO₂ per Km = Electricity Consumption per Km × Emission Factor of Electricity

## Purpose:
Measures carbon emissions generated by EV usage
Helps evaluate environmental impact of EVs
Used in sustainability analysis

### 6. Petrol CO₂ Per Km (g)

Calculation: Petrol CO₂ per Km = CO₂ Emission per Liter / Mileage

## Purpose:
Calculates emissions produced by petrol vehicles per km
Provides baseline for environmental comparison
Used to quantify emission reduction

### 7. CO₂ Saving Per Km (g)
Calculation: CO₂ Saving per Km = Petrol CO₂ per Km – EV CO₂ per Km

## Purpose:
Measures emission reduction achieved by switching to EV
Core sustainability metric
Used to estimate total environmental benefits

### 8. Break-even Years
Calculation: Break-even Years = (EV Purchase Cost – Petrol Vehicle Cost) / Annual Savings

## Purpose:
Calculates the time required to recover higher EV cost
Critical for investment decision-making
Helps users understand long-term financial viability

### 9. ICE Sales
Calculation: ICE Sales = Total Vehicle Sales – EV Sales

## Purpose:
Represents internal combustion engine (petrol/diesel) vehicle sales
Needed to compare EV vs traditional vehicle adoption
Used in calculating EV share

### 10. EV Share (%)
Calculation: EV Share % = (EV Sales / Total Vehicle Sales) × 100

## Purpose:
Measures percentage of EVs in total vehicle sales
Key indicator of EV adoption rate
Widely used in trend and country-level analysis
