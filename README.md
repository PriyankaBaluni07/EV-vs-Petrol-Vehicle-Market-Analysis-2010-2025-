...
### Purpose:
1) Calculates the fuel cost per kilometer for petrol vehicles
2) Enables direct comparison with EV running cost
3) Critical for evaluating cost efficiency gap

## 3. Cost Saving Per Km
Calculation: Cost Saving per Km = Petrol Cost per Km – EV Cost per Km

### Purpose:
1) Measures savings achieved by using EV instead of petrol vehicle
2) Core metric for financial comparison
3) Used to calculate long-term savings and break-even period

## 4. Annual Savings (USD)
Calculation: Annual Savings = Cost Saving per Km × Annual Distance Travelled

### Purpose:
1) Estimates total yearly savings from EV usage
2) Converts per km savings into real-world financial impact
3) Key input for break-even analysis

## 5. EV CO₂ Per Km (g)
Calculation: EV CO₂ per Km = Electricity Consumption per Km × Emission Factor of Electricity

### Purpose:
1) Measures carbon emissions generated by EV usage
2) Helps evaluate environmental impact of EVs
3) Used in sustainability analysis
...
### Purpose:
1) Calculates emissions produced by petrol vehicles per km
2) Provides baseline for environmental comparison
3) Used to quantify emission reduction
